...
struct SnapCarousel: View
{
    ...
    var body: some View
    {
        ...
        let items = [
            Card(id: 0, img: "atm_bromo", name: "Hey", show: false),
            Card(id: 1, img: "atm_bromo", name: "Ho", show: false),
            Card(id: 2, img: "atm_bromo", name: "Lets", show: false),
            Card(id: 3, img: "atm_bromo", name: "Go", show: false)
        ]
